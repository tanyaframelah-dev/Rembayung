            ...
            <div className="max-w-7xl mx-auto px-6 h-full flex justify-between items-center">
              ...
              <div className="flex-1 flex justify-end items-center gap-4">
                 <button 
                    ...
                    className="bg-airbnb-red hover:bg-airbnb-dark text-white px-5 py-2.5 rounded-full font-bold text-sm transition-all transform active:scale-95 shadow-md hidden sm:block"
                 >
                    Reserve
                 </button>
